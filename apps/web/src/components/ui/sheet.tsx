    ...
    <Dialog.Portal>
      ...
      <Dialog.Content
        className={cn(
          ...
          side === "bottom" &&
            "inset-x-0 bottom-0 max-h-[85dvh] rounded-t-2xl border-t border-border p-5 sm:p-6 data-[state=open]:animate-sheet-in-bottom data-[state=closed]:animate-sheet-out-bottom"
        )}
      >
